    ...
    this.keydown= function( ev ) {
        ...
        switch ( ev.key) {
            ...
            */
            ...
            // X-axis rotation: r for clockwise, f for counterclockwise
            case 'r': // 顺时针绕 X 轴
                if (this.selected_box) {
                    this.boxOp.rotate_x(this.selected_box, this.editorCfg.rotateStep, false);
                    this.on_box_changed(this.selected_box);
                }
                break;
            case 'f': // 逆时针绕 X 轴
            ...
            // Y-axis rotation: z for clockwise, c for counterclockwise
            case 'y': // 顺时针绕 Y 轴
                if (this.selected_box) {
                    this.boxOp.rotate_y(this.selected_box, this.editorCfg.rotateStep, false);
                    this.on_box_changed(this.selected_box);
                }
                break;
            case 'h': // 逆时针绕 Y 轴

...
class ObjectCategory
{
    ...
    obj_type_map = {
        ...
        bag:  {color: '#86af49',  size:[0.4, 0.5, 1.7], attr:["is occluded", "not occluded", "easy to pick", "hard to pick"]},
        box:  {color: '#ff0000',  size:[0.4, 0.5, 1.7], attr:["is occluded", "not occluded", "easy to pick", "hard to pick"]},
    ...
    // popularCategories = ["Car", "Pedestrian", "Van", "bag", "box", "Bus", "Truck", "Scooter", "ScooterRider", "Bicycle", "BicycleRider"];
    popularCategories = ["bag", "box",];

...
function BoxOp(){
    ...
    this.rotate_x = function(box, theta, sticky) {
        var points_indices = box.world.lidar.get_points_indices_of_box(box);
        var _tempQuaternion = new Quaternion();
        var rotationAxis = new Vector3(1, 0, 0); // 绕 x 轴
        box.quaternion.multiply(_tempQuaternion.setFromAxisAngle(rotationAxis, theta)).normalize();
    ...
    this.rotate_y = function(box, theta, sticky) {
        var points_indices = box.world.lidar.get_points_indices_of_box(box);
        var _tempQuaternion = new Quaternion();
        var rotationAxis = new Vector3(0, 1, 0); // 绕 y 轴
        box.quaternion.multiply(_tempQuaternion.setFromAxisAngle(rotationAxis, theta)).normalize();
